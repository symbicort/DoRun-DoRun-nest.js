...
let UserRepository = class UserRepository {
    ...
    async existsByNickname(nickname) {
    ...
    async updateProfileImg(userId, awsurl) {
    ...
    async refreshTokenToNull(userId) {
        await this.userRepository
            .createQueryBuilder()
            .update(user_entity_1.User)
            .set({ refreshKey: null })
    ...
    async findNicknameFromToken(refreshToken) {
        return await this.userRepository.findOne({
            where: { refreshKey: refreshToken },
        });
    }
    async updatePassword(userId, encryptPw) {
        await this.userRepository
            .createQueryBuilder()
            .update(user_entity_1.User)
